<div class="container-fluid" style="padding-bottom: 5em;">
   <div class="row" style="background-color: #F5F5F5; padding-left: 20vh; padding-right: 20vh;padding-top: 7em; color: grey;">
      <small><a href="<?php echo base_url().'Home'?>" style="text-decoration: none; color: black;">HOME</a> / <a href="<?php echo base_url().'Home/viewprofile'?>" style="text-decoration: none; color: black;"> MY ACCOUNT </a> / ORDERS</small>
    </div>
    <div class="row" style="background-color: #F5F5F5;padding-top: 1em; padding-bottom: 6vh;padding-left: 20vh; padding-right: 20vh;">
      <h1 class="head" style="font-weight: 700;"><span style="border-bottom: 5px solid #e51937; padding-bottom: 5px;">OR</span>DERS</h1>
    </div>
    ...
    <div class="woocommerce-message woocommerce-message--info woocommerce-Message woocommerce-Message--info woocommerce-info" style="background-color: #A7B9C3;
    color: #fff;">
    <span style="margin-left: 5px; margin-right: 25.5em;">No order has been made yet.</span>
      <a class="button" href="#" style="border: 2px solid currentColor;color:#000;-webkit-border-radius: 3px;transition: all 0.3s ease-in-out;text-decoration: none;font-size: 14px;line-height: 22px;font-weight: 700;text-transform: uppercase;padding: 15px 35px;display: inline-block;background-color: transparent;margin-top: 5px;margin-bottom: 5px;margin-right: 5px;border-left-color: currentColor !important;">Go shop</a>              
